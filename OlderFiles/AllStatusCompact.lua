...
function generateHtml()
    ...
    function BarGraph(percent)
        ...
        return "<td class=\"bar\" > 
                    <svg >
                        <rect x=\"0\" y=\"5\" height=\"20\" width=\"140\" stroke=\"white\" stroke-width=\"1\"  rx=\"4\" />
                        <rect x=\"0\" y=\"5\" height=\"20\" width=\"" .. percent * 1.4 .. "\"  fill=\"" .. barcolour .. "\" opacity=\"0.8\" rx=\"2\"/>
                        <text x=\"5\" y=\"20\" fill=\"white\" text-align=\"center\" margin-left=\"5\">" .. percent .. "%</text> 
                    </svg>
                </td>"        
    end
