...
function generateHtml()
    ...
    function Status(percent)
        ...
        elseif percent > 0 and percent <=25 then return "<th style=\"color: red;\">CRITCAL</th>"
