...
function generateHtml()
    ...
    for i = 1, #elementsIds do
        if string.match(core.getElementTypeById(elementsIds[i]), "Container") and string.match(core.getElementNameById(elementsIds[i]),"Ore") or string.match(core.getElementNameById(elementsIds[i]),"Pure") then
    ...
    function Status(percent)
        ...
        elseif percent > 0 and percent <=25 then return "<th style=\"color: orange;\">CRITCAL</th>"
    ...
    local maxOreContainerVol = 358400 --export: This is the maximum volume allowed in the container. Update as needed
    local pureContainerSelfMass = 0 --export: This is the mass of the container, hubs are 0
    local maxPureContainerVol = 358400 --export: This is the maximum volume allowed in the container. Update as needed
